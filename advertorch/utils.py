...
#         if min.ndimension() == 1 and min.shape[0] == batch_size:
#             input = torch.max(input, min.view(batch_size, *([1] * (ndim - 1))))
#         else:
...
#         if max.ndimension() == 1 and max.shape[0] == batch_size:
#             input = torch.min(input, max.view(batch_size, *([1] * (ndim - 1))))
#         else:
